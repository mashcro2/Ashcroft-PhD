#Data from SDR 2020 from OECD countries excluding Mexico, USA, Iceland
...
OECD_countries<-grep("^(Japan|Germany|Turkey|France|United Kingdom|Italy|Korea, Rep.|Spain|
...
|Latvia|Estonia|Luxembourg)",data$Country)
...
data.xform.pan$sdg9_patents <- -((-data.pan$sdg9_patents+1)^(2-TransformParams.pan[["yj"]][["sdg9_patents"]])-1)/(2-TransformParams.pan[["yj"]][["sdg9_patents"]])
min(data.xform.pan$sdg9_rdex)
TransformParams.pan[["yj"]][["sdg9_rdex"]]
data.xform.pan$sdg9_rdex <- -((-data.pan$sdg9_rdex+1)^(2-TransformParams.pan[["yj"]][["sdg9_rdex"]])-1)/(2-TransformParams.pan[["yj"]][["sdg9_rdex"]])
min(data.xform.pan$sdg3_matmort)
TransformParams.pan[["yj"]][["sdg3_matmort"]]
data.xform.pan$sdg3_matmort <- -((-data.pan$sdg3_matmort+1)^(2-TransformParams.pan[["yj"]][["sdg3_matmort"]])-1)/(2-TransformParams.pan[["yj"]][["sdg3_matmort"]])
TransformParams.pan[["yj"]][["sdg16_prison"]]
data.xform.pan$sdg16_prison <- -((-data.pan$sdg16_prison+1)^(2-TransformParams.pan[["yj"]][["sdg16_prison"]])-1)/(2-TransformParams.pan[["yj"]][["sdg16_prison"]])
TransformParams.pan[["yj"]][["sdg8_yneet"]]
data.xform.pan$sdg8_yneet <- -((-data.pan$sdg8_yneet+1)^(2-TransformParams.pan[["yj"]][["sdg8_yneet"]])-1)/(2-TransformParams.pan[["yj"]][["sdg8_yneet"]])
min(data.xform.pan$sdg8_impacc)
TransformParams.pan[["yj"]][["sdg8_impacc"]]
data.xform.pan$sdg8_impacc <- -((-data.pan$sdg8_impacc+1)^(2-TransformParams.pan[["yj"]][["sdg8_impacc"]])-1)/(2-TransformParams.pan[["yj"]][["sdg8_impacc"]])
TransformParams.pan[["yj"]][["sdg2_trophic"]]
data.xform.pan$sdg2_trophic <- -((-data.pan$sdg2_trophic+1)^(2-TransformParams.pan[["yj"]][["sdg2_trophic"]])-1)/(2-TransformParams.pan[["yj"]][["sdg2_trophic"]])
TransformParams.pan[["yj"]][["sdg11_pm25"]]
data.xform.pan$sdg11_pm25 <- -((-data.pan$sdg11_pm25+1)^(2-TransformParams.pan[["yj"]][["sdg11_pm25"]])-1)/(2-TransformParams.pan[["yj"]][["sdg11_pm25"]])
TransformParams.pan[["yj"]][["sdg10_elder"]]
data.xform.pan$sdg10_elder <- -((-data.pan$sdg10_elder+1)^(2-TransformParams.pan[["yj"]][["sdg10_elder"]])-1)/(2-TransformParams.pan[["yj"]][["sdg10_elder"]])
TransformParams.pan[["yj"]][["sdg11_transport"]]
data.xform.pan$sdg11_transport <- -((-data.pan$sdg11_transport+1)^(2-TransformParams.pan[["yj"]][["sdg11_transport"]])-1)/(2-TransformParams.pan[["yj"]][["sdg11_transport"]])
TransformParams.pan[["yj"]][["sdg16_rsf"]]
data.xform.pan$sdg16_rsf <- -((-data.pan$sdg16_rsf+1)^(2-TransformParams.pan[["yj"]][["sdg16_rsf"]])-1)/(2-TransformParams.pan[["yj"]][["sdg16_rsf"]])
TransformParams.pan[["yj"]][["sdg6_scarcew"]]
data.xform.pan$sdg6_scarcew <- -((-data.pan$sdg6_scarcew+1)^(2-TransformParams.pan[["yj"]][["sdg6_scarcew"]])-1)/(2-TransformParams.pan[["yj"]][["sdg6_scarcew"]])
TransformParams.pan[["yj"]][["sdg1_oecdpov"]]
data.xform.pan$sdg1_oecdpov <- -((-data.pan$sdg1_oecdpov+1)^(2-TransformParams.pan[["yj"]][["sdg1_oecdpov"]])-1)/(2-TransformParams.pan[["yj"]][["sdg1_oecdpov"]])
TransformParams.pan[["yj"]][["sdg17_govex"]]
data.xform.pan$sdg17_govex <- -((-data.pan$sdg17_govex+1)^(2-TransformParams.pan[["yj"]][["sdg17_govex"]])-1)/(2-TransformParams.pan[["yj"]][["sdg17_govex"]])
TransformParams.pan[["yj"]][["sdg5_paygap"]]
data.xform.pan$sdg5_paygap <- -((-data.pan$sdg5_paygap+1)^(2-TransformParams.pan[["yj"]][["sdg5_paygap"]])-1)/(2-TransformParams.pan[["yj"]][["sdg5_paygap"]])
TransformParams.pan[["yj"]][["sdg13_co2import"]]
data.xform.pan$sdg13_co2import <- -((-data.pan$sdg13_co2import+1)^(2-TransformParams.pan[["yj"]][["sdg13_co2import"]])-1)/(2-TransformParams.pan[["yj"]][["sdg13_co2import"]])
TransformParams.pan[["yj"]][["sdg2_stuntihme"]]
data.xform.pan$sdg2_stuntihme <- -((-data.pan$sdg2_stuntihme+1)^(2-TransformParams.pan[["yj"]][["sdg2_stuntihme"]])-1)/(2-TransformParams.pan[["yj"]][["sdg2_stuntihme"]])
TransformParams.pan[["yj"]][["sdg3_tb"]]
data.xform.pan$sdg3_tb <- -((-data.pan$sdg3_tb+1)^(2-TransformParams.pan[["yj"]][["sdg3_tb"]])-1)/(2-TransformParams.pan[["yj"]][["sdg3_tb"]])
TransformParams.pan[["yj"]][["sdg14_cleanwat"]]
data.xform.pan$sdg14_cleanwat <- -((-data.pan$sdg14_cleanwat+1)^(2-TransformParams.pan[["yj"]][["sdg14_cleanwat"]])-1)/(2-TransformParams.pan[["yj"]][["sdg14_cleanwat"]])
TransformParams.pan[["yj"]][["sdg7_co2twh"]]
data.xform.pan$sdg7_co2twh <- -((-data.pan$sdg7_co2twh+1)^(2-TransformParams.pan[["yj"]][["sdg7_co2twh"]])-1)/(2-TransformParams.pan[["yj"]][["sdg7_co2twh"]])
TransformParams.pan[["yj"]][["sdg5_parl"]]
data.xform.pan$sdg5_parl <- -((-data.pan$sdg5_parl+1)^(2-TransformParams.pan[["yj"]][["sdg5_parl"]])-1)/(2-TransformParams.pan[["yj"]][["sdg5_parl"]])
TransformParams.pan[["yj"]][["sdg11_rentover"]]
data.xform.pan$sdg11_rentover <- -((-data.pan$sdg11_rentover+1)^(2-TransformParams.pan[["yj"]][["sdg11_rentover"]])-1)/(2-TransformParams.pan[["yj"]][["sdg11_rentover"]])
TransformParams.pan[["yj"]][["sdg2_crlyld"]]
data.xform.pan$sdg2_crlyld <- -((-data.pan$sdg2_crlyld+1)^(2-TransformParams.pan[["yj"]][["sdg2_crlyld"]])-1)/(2-TransformParams.pan[["yj"]][["sdg2_crlyld"]])
TransformParams.pan[["yj"]][["sdg3_incomeg"]]
data.xform.pan$sdg3_incomeg <- -((-data.pan$sdg3_incomeg+1)^(2-TransformParams.pan[["yj"]][["sdg3_incomeg"]])-1)/(2-TransformParams.pan[["yj"]][["sdg3_incomeg"]])
TransformParams.pan[["yj"]][["sdg9_articles"]]
data.xform.pan$sdg9_articles <- -((-data.pan$sdg9_articles+1)^(2-TransformParams.pan[["yj"]][["sdg9_articles"]])-1)/(2-TransformParams.pan[["yj"]][["sdg9_articles"]])
TransformParams.pan[["yj"]][["sdg14_trawl"]]
data.xform.pan$sdg14_trawl <- -((-data.pan$sdg14_trawl+1)^(2-TransformParams.pan[["yj"]][["sdg14_trawl"]])-1)/(2-TransformParams.pan[["yj"]][["sdg14_trawl"]])
TransformParams.pan[["yj"]][["sdg14_fishstocks"]]
data.xform.pan$sdg14_fishstocks <- -((-data.pan$sdg14_fishstocks+1)^(2-TransformParams.pan[["yj"]][["sdg14_fishstocks"]])-1)/(2-TransformParams.pan[["yj"]][["sdg14_fishstocks"]])
TransformParams.pan[["yj"]][["sdg9_rdres"]]
data.xform.pan$sdg14_fishstocks <- -((-data.pan$sdg14_fishstocks+1)^(2-TransformParams.pan[["yj"]][["sdg14_fishstocks"]])-1)/(2-TransformParams.pan[["yj"]][["sdg14_fishstocks"]])
TransformParams.pan[["yj"]][["sdg1_320pov"]]
data.xform.pan$sdg1_320pov <- -((-data.pan$sdg1_320pov+1)^(2-TransformParams.pan[["yj"]][["sdg1_320pov"]])-1)/(2-TransformParams.pan[["yj"]][["sdg1_320pov"]])
TransformParams.pan[["yj"]][["sdg3_neonat"]]
data.xform.pan$sdg3_neonat <- -((-data.pan$sdg3_neonat+1)^(2-TransformParams.pan[["yj"]][["sdg3_neonat"]])-1)/(2-TransformParams.pan[["yj"]][["sdg3_neonat"]])
TransformParams.pan[["yj"]][["sdg3_smoke"]]
data.xform.pan$sdg3_smoke <- -((-data.pan$sdg3_smoke+1)^(2-TransformParams.pan[["yj"]][["sdg3_smoke"]])-1)/(2-TransformParams.pan[["yj"]][["sdg3_smoke"]])
TransformParams.pan[["yj"]][["sdg16_homicides"]]
data.xform.pan$sdg16_homicides <- -((-data.pan$sdg16_homicides+1)^(2-TransformParams.pan[["yj"]][["sdg16_homicides"]])-1)/(2-TransformParams.pan[["yj"]][["sdg16_homicides"]])
TransformParams.pan[["yj"]][["sdg9_netacc"]]
data.xform.pan$sdg9_netacc <- -((-data.pan$sdg9_netacc+1)^(2-TransformParams.pan[["yj"]][["sdg9_netacc"]])-1)/(2-TransformParams.pan[["yj"]][["sdg9_netacc"]])
TransformParams.pan[["yj"]][["sdg3_u5mort"]]
data.xform.pan$sdg3_u5mort <- -((-data.pan$sdg3_u5mort+1)^(2-TransformParams.pan[["yj"]][["sdg3_u5mort"]])-1)/(2-TransformParams.pan[["yj"]][["sdg3_u5mort"]])
TransformParams.pan[["yj"]][["sdg4_tertiary"]]
data.xform.pan$sdg4_tertiary <- -((-data.pan$sdg4_tertiary+1)^(2-TransformParams.pan[["yj"]][["sdg4_tertiary"]])-1)/(2-TransformParams.pan[["yj"]][["sdg4_tertiary"]])
TransformParams.pan[["yj"]][["sdg15_cpfa"]]
data.xform.pan$sdg15_cpfa <- -((-data.pan$sdg15_cpfa+1)^(2-TransformParams.pan[["yj"]][["sdg15_cpfa"]])-1)/(2-TransformParams.pan[["yj"]][["sdg15_cpfa"]])
TransformParams.pan[["yj"]][["sdg15_cpta"]]
data.xform.pan$sdg15_cpta <- -((-data.pan$sdg15_cpta+1)^(2-TransformParams.pan[["yj"]][["sdg15_cpta"]])-1)/(2-TransformParams.pan[["yj"]][["sdg15_cpta"]])
TransformParams.pan[["yj"]][["sdg14_cpma"]]
data.xform.pan$sdg14_cpma <- -((-data.pan$sdg14_cpma+1)^(2-TransformParams.pan[["yj"]][["sdg14_cpma"]])-1)/(2-TransformParams.pan[["yj"]][["sdg14_cpma"]])
TransformParams.pan[["yj"]][["sdg10_adjgini"]]
data.xform.pan$sdg10_adjgini <- -((-data.pan$sdg10_adjgini+1)^(2-TransformParams.pan[["yj"]][["sdg10_adjgini"]])-1)/(2-TransformParams.pan[["yj"]][["sdg10_adjgini"]])
TransformParams.pan[["yj"]][["sdg2_wasteihme"]]
data.xform.pan$sdg2_wasteihme <- -((-data.pan$sdg2_wasteihme+1)^(2-TransformParams.pan[["yj"]][["sdg2_wasteihme"]])-1)/(2-TransformParams.pan[["yj"]][["sdg2_wasteihme"]])
TransformParams.pan[["yj"]][["sdg1_wpc"]]
data.xform.pan$sdg1_wpc <- -((-data.pan$sdg1_wpc+1)^(2-TransformParams.pan[["yj"]][["sdg1_wpc"]])-1)/(2-TransformParams.pan[["yj"]][["sdg1_wpc"]])
TransformParams.pan[["yj"]][["sdg9_intuse"]]
data.xform.pan$sdg9_intuse <- -((-data.pan$sdg9_intuse+1)^(2-TransformParams.pan[["yj"]][["sdg9_intuse"]])-1)/(2-TransformParams.pan[["yj"]][["sdg9_intuse"]])
TransformParams.pan[["yj"]][["sdg16_safe"]]
data.xform.pan$sdg16_safe <- -((-data.pan$sdg16_safe+1)^(2-TransformParams.pan[["yj"]][["sdg16_safe"]])-1)/(2-TransformParams.pan[["yj"]][["sdg16_safe"]])
TransformParams.pan[["yj"]][["sdg2_obesity"]]
data.xform.pan$sdg2_obesity <- -((-data.pan$sdg2_obesity+1)^(2-TransformParams.pan[["yj"]][["sdg2_obesity"]])-1)/(2-TransformParams.pan[["yj"]][["sdg2_obesity"]])
TransformParams.pan[["yj"]][["sdg16_cpi"]]
data.xform.pan$sdg16_cpi <- -((-data.pan$sdg16_cpi+1)^(2-TransformParams.pan[["yj"]][["sdg16_cpi"]])-1)/(2-TransformParams.pan[["yj"]][["sdg16_cpi"]])
TransformParams.pan[["yj"]][["sdg2_snmi"]]
data.xform.pan$sdg2_snmi <- -((-data.pan$sdg2_snmi+1)^(2-TransformParams.pan[["yj"]][["sdg2_snmi"]])-1)/(2-TransformParams.pan[["yj"]][["sdg2_snmi"]])
TransformParams.pan[["yj"]][["sdg8_empop"]]
data.xform.pan$sdg8_empop <- -((-data.pan$sdg8_empop+1)^(2-TransformParams.pan[["yj"]][["sdg8_empop"]])-1)/(2-TransformParams.pan[["yj"]][["sdg8_empop"]])
TransformParams.pan[["yj"]][["sdg17_oda"]]
data.xform.pan$sdg17_oda <- -((-data.pan$sdg17_oda+1)^(2-TransformParams.pan[["yj"]][["sdg17_oda"]])-1)/(2-TransformParams.pan[["yj"]][["sdg17_oda"]])
TransformParams.pan[["yj"]][["sdg13_co2kgPerGDPPPP"]]
data.xform.pan$sdg13_co2kgPerGDPPPP <- -((-data.pan$sdg13_co2kgPerGDPPPP+1)^(2-TransformParams.pan[["yj"]][["sdg13_co2kgPerGDPPPP"]])-1)/(2-TransformParams.pan[["yj"]][["sdg13_co2kgPerGDPPPP"]])
...
ScaleParams <- preProcess(data.pan[,indx.pan], method=c("range"), rangeBounds = c(0,1))
#ScaleParams <- preProcess(data.pan[,indx.pan], method=c("center","scale"))
data.xform.pan[,indx.pan]<-predict(ScaleParams, data.pan[,indx.pan])
summary(data.xform.pan)
...
# targ13col<-grep("^(sdg13_co2kgPerGDPPPP)",colnames(data.imp.final.xf))
# targ13colnm<-grep("^(sdg13_co2kgPerGDPPPP)",names(vars_nomiss))
# vars_sdg13<-vars_nomiss[c(-1:-3,-targ13colnm)] #CO2 is 44th member of the vars_nomiss vector
# lasso_input_sdg13 <- data.imp.final.xf[,vars_sdg13] #Use all vars except year, country, id, co2 target
# lasso_target_sdg13 <- data.imp.final.xf[,targ13col] #CO2 is the 60th column of data.imp.final.xf dataframe
...
#   family = c("gaussian"))
# 
# coef(Lasso_sdg13_co2kgPerGDPPPP, s = c(0.01,0.015,0.02)) #alter s(lambda to get a resonable number of vars)
# 
...
#Lasso inputs with transformed pan imputed vars. Lambda = 0.03. hiv, fplmodel, empop, prison out. wpc, crlyld, snmi, cpfa in
fit_plm_imp_pan_sdg1.xfL<-plm(sdg1_oecdpov ~ sdg1_wpc + sdg2_crlyld + sdg2_snmi + sdg4_tertiary 
                              + sdg10_adjgini + sdg10_palma + sdg10_elder + sdg15_cpfa  + sdg16_rsf,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars. s = 0.013, then pruned.
fit_plm_imp_pan_sdg1.xfLP<-plm(sdg1_oecdpov ~ sdg2_crlyld + sdg2_snmi + sdg4_tertiary
                               + sdg8_empop + sdg10_palma
                               + sdg10_elder + sdg16_rsf + sdg17_oda,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars. s= 0.015. wpc, primary out. tertiary, rsf in
fit_plm_imp_pan_sdg2.xfL<-plm(sdg2_undernsh ~ sdg2_wasteihme + sdg3_lifee + sdg3_fertility + sdg4_tertiary + sdg7_elecac 
                              + sdg7_cleanfuel + sdg13_co2kgPerGDPPPP + sdg16_rsf,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars. s = 0.008, then pruned. 
fit_plm_imp_pan_sdg2.xfLP<-plm(sdg2_undernsh ~ sdg2_wasteihme + sdg2_obesity
                               + sdg3_fertility + sdg6_safewat + sdg7_cleanfuel + sdg8_yneet
                               + sdg11_pipedwat + sdg13_co2kgPerGDPPPP + sdg16_homicides,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.05 (higher than others)). tb, intuse, netacc, safe out. smoke, articles, redlist, homicides in
fit_plm_imp_pan_sdg3.xfL<-plm(sdg3_lifee ~ GDP_PPP + sdg2_stuntihme + sdg2_wasteihme + sdg3_smoke
                              + sdg4_tertiary + sdg6_safewat + sdg9_articles + sdg15_redlist + sdg16_homicides,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
fit_plm_imp_pan_sdg3.xfLP<-plm(sdg3_lifee ~ GDP_PPP + sdg3_matmort + sdg3_smoke + sdg4_tertiary
                               + sdg9_articles + sdg13_co2kgPerGDPPPP + sdg16_homicides + sdg16_safe,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
# Extra Pruned Lasso inputs with transformed pan imputed vars
fit_plm_imp_pan_sdg3.xfLP2<-plm(sdg3_lifee ~ GDP_PPP + sdg3_smoke + sdg4_tertiary
                                + sdg9_articles + sdg13_co2kgPerGDPPPP,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.035). Neonat, rdres out. Fertility, rdex in
fit_plm_imp_pan_sdg4.xfL<-plm(sdg4_tertiary ~ sdg1_oecdpov + sdg2_undernsh + sdg3_lifee + sdg3_fertility 
                              + sdg5_paygap + sdg8_yneet + sdg9_intuse + sdg9_rdex,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars. s=0.015, then pruned.
fit_plm_imp_pan_sdg4.xfLP<-plm(sdg4_tertiary ~ sdg1_320pov + sdg2_undernsh + sdg3_lifee + sdg3_swb 
                               + sdg7_ren + sdg8_yneet + sdg9_intuse + sdg9_rdex,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Extra Pruned Lasso inputs with transformed pan imputed vars
fit_plm_imp_pan_sdg4.xfLP2<-plm(sdg4_tertiary ~ sdg1_320pov + sdg3_lifee
                                + sdg8_yneet + sdg9_intuse + sdg9_rdex,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.065). Trophic, Swb, smoke, articles out. Wasting, safe, cpi, rsf in.
fit_plm_imp_pan_sdg5.xfL<-plm(sdg5_parl ~ sdg2_wasteihme + sdg5_lfpr + sdg7_ren + sdg9_intuse
                              + sdg16_safe + sdg16_cpi + sdg16_rsf + sdg17_govex + sdg17_oda,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars (lambda = 0.03)
fit_plm_imp_pan_sdg5.xfLP<-plm(sdg5_parl ~ sdg2_wasteihme + sdg2_snmi + sdg5_lfpr + sdg5_paygap + sdg6_safesan
                               + sdg9_intuse + sdg9_rdres + sdg16_rsf,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Extra Pruned Lasso inputs with transformed pan imputed vars (lambda = 0.03)
fit_plm_imp_pan_sdg5.xfLP2<-plm(sdg5_parl ~ sdg5_lfpr + sdg6_safesan + sdg9_intuse + sdg9_rdres,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.055). 320pov, elecac, ren, patents, pipedwat, cpta out. Neonat, patents, palma, cpma, cpfa in
fit_plm_imp_pan_sdg6.xfL<-plm(sdg6_safesan ~ sdg3_neonat + sdg3_fertility + sdg4_earlyedu + sdg9_intuse + sdg9_patents
                              + sdg10_palma + sdg14_cpma + sdg15_cpfa,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars. s=0.025 then pruned
fit_plm_imp_pan_sdg6.xfLP<-plm(sdg6_safesan ~ sdg3_fertility + sdg5_parl
                               + sdg5_paygap + sdg7_elecac + sdg9_intuse + sdg9_patents + sdg10_palma
                               + sdg14_cpma + sdg15_cpta,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Extra Pruned Lasso inputs with transformed pan imputed vars
fit_plm_imp_pan_sdg6.xfLP2<-plm(sdg6_safesan ~ sdg3_fertility + sdg5_parl + sdg7_elecac + sdg9_intuse + sdg9_patents,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.04). Empop, cpma, cleanwat, safesan out. HIV, impacc, rentover in
fit_plm_imp_pan_sdg7.xfL<-plm(sdg7_ren ~ Population + sdg2_trophic + sdg3_hiv + sdg5_parl + sdg5_paygap
                              + sdg8_impacc + sdg11_rentover + sdg13_co2kgPerGDPPPP,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars. s=0.02, then pruned. SNMI has a huge effect on R^2 despite not being significant. R^2 = 0.58 vs 0.41 without it
fit_plm_imp_pan_sdg7.xfLP<-plm(sdg7_ren ~ Population + sdg2_trophic + sdg2_snmi + sdg3_matmort + sdg5_lfpr
                               + sdg8_impacc + sdg8_empop + sdg11_pm25 + sdg13_co2kgPerGDPPPP,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Extra Pruned Lasso inputs with transformed pan imputed vars. Stunting replaced SNMI from model with all countries and that performed better than with new lasso vars and remains significant. 
fit_plm_imp_pan_sdg7.xfLP2<-plm(sdg7_ren ~ sdg2_trophic + sdg2_stuntihme + sdg5_lfpr + sdg11_pm25 + sdg13_co2kgPerGDPPPP,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
fit_plm_imp_pan_sdg7.collste<-plm(sdg7_elecac ~ sdg3_lifee + sdg9_intuse + sdg4_tertiary,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.023). Trophic, swb out. Lfpr, patents in
fit_plm_imp_pan_sdg8.xfL<-plm(sdg8_empop ~ sdg5_lfpr + sdg7_ren + sdg8_yneet + sdg9_intuse
                              + sdg9_patents + sdg11_pm25 + sdg16_cpi,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars. Lagging yneet helped R^2, MSR, and didn't make model insignificant. Yneet carries the model
fit_plm_imp_pan_sdg8.xfLP<-plm(sdg8_empop ~ GDP_PPP + sdg3_swb + sdg3_incomeg + sdg4_second + sdg4_earlyedu
                               + sdg8_yneet + sdg9_intuse + sdg11_pm25,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
fit_plm_imp_pan_sdg8.xfLP2<-plm(sdg8_empop ~ sdg3_incomeg + sdg8_yneet + sdg9_intuse + sdg11_pm25,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.03). Undernsh, elder out. Fertility, cleanwat in
fit_plm_imp_pan_sdg9.xfL<-plm(sdg9_rdex ~ sdg3_lifee + sdg3_fertility + sdg5_paygap + sdg9_articles + sdg9_rdres + sdg9_patents
                              + sdg14_cleanwat + sdg15_cpta,
                              model='random',
                              effect='twoway',
                              data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars
fit_plm_imp_pan_sdg9.xfLP<-plm(sdg9_rdex ~ sdg2_undernsh + sdg3_lifee + sdg3_smoke
                               + sdg5_paygap + sdg8_impacc + sdg9_articles + sdg9_rdres + sdg9_patents,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Extra Pruned Lasso inputs with transformed pan imputed vars. Same vars as full suite of countries
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.018). Crlyld, fplmodel out. Matmort, pm 2.5, cleanwat in.
fit_plm_imp_pan_sdg10.xfL<-plm(sdg10_palma ~ sdg1_oecdpov + sdg2_wasteihme + sdg2_crlyld + sdg3_fertility 
                               + sdg7_elecac + sdg10_adjgini + sdg11_pm25 + sdg14_cleanwat,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
fit_plm_imp_pan_sdg10.xfLP<-plm(sdg10_palma ~ sdg1_320pov + sdg1_oecdpov + sdg4_tertiary
                                + sdg5_fplmodel + sdg6_safesan + sdg10_adjgini
                                + sdg11_pm25 + sdg14_cleanwat,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Extra Pruned Lasso inputs with transformed pan imputed vars. With ONLY Oecdpov, the R^2 is stil 0.57445
fit_plm_imp_pan_sdg10.xfLP2<-plm(sdg10_palma ~ sdg1_oecdpov + sdg4_tertiary + sdg6_safesan,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf)
...
#SDG11#
fit_plm_imp_pan_sdg11.xf<-plm(sdg11_pm25 ~ sdg7_ren + sdg5_parl + sdg7_cleanfuel
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.03). neonat added
fit_plm_imp_pan_sdg11.xfL<-plm(sdg11_pm25 ~ sdg2_trophic + sdg3_neonat + sdg5_edat + sdg5_lfpr + sdg8_impacc + sdg8_empop + sdg9_rdex
                               + sdg16_cpi + sdg16_rsf,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars. Strange pruning process where removing some vars increased R^2 by a lot. Adding significant vars even decreased R^2
#Changing model type to pooling increased R^2 from 0.334 to 0.846
fit_plm_imp_pan_sdg11.xfLP<-plm(sdg11_pm25 ~ sdg1_wpc + sdg2_trophic + sdg3_neonat + sdg3_vac
                                + sdg5_edat + sdg5_lfpr + sdg6_scarcew + sdg7_elecac + sdg8_impacc + sdg8_empop + sdg9_rdres
                                + sdg16_cpi + sdg16_rsf,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Pooling also increases R^2 greatly here
fit_plm_imp_pan_sdg11.xfLP2<-plm(sdg11_pm25 ~ sdg3_neonat + sdg3_vac + sdg5_lfpr + sdg8_empop + sdg9_rdres,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf)
...
fit_plm_imp_pan_sdg11.xfLPt<-plm(sdg11_pm25 ~ sdg1_wpc + sdg2_trophic + lag(sdg2_trophic)
                                 + sdg3_neonat + lag(sdg3_neonat) + sdg3_vac + lag(sdg3_vac) + sdg5_edat
                                 + sdg5_lfpr + lag(sdg5_lfpr) + lag(sdg6_scarcew) + sdg7_elecac
                                 + sdg8_empop + lag(sdg8_empop) + sdg9_rdres + lag(sdg9_rdres),
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.025). prison and transport replaced by crlyld and cleanfuel when countries excluded
fit_plm_imp_pan_sdg13.xfL<-plm(sdg13_co2kgPerGDPPPP ~ sdg2_crlyld + sdg3_lifee + sdg4_earlyedu + sdg5_paygap + sdg7_cleanfuel
                               + sdg7_ren + sdg9_intuse + sdg16_rsf,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars (lambda = 0.01 then pruned). Removing patents greatly reduces R^2, even though it isn't significant. 
#Tertiary and patents contain similar information
fit_plm_imp_pan_sdg13.xfLP<-plm(sdg13_co2kgPerGDPPPP ~ sdg2_wasteihme + sdg3_lifee
                                + sdg7_cleanfuel + sdg7_ren + sdg9_intuse + sdg9_patents + sdg14_cleanwat + sdg15_cpfa,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Extra pruned Lasso inputs with transformed pan imputed vars (lambda = 0.01 then pruned). added patents back in at the end which improved R^2. cpta subbed for cpfa and R^2 improved
fit_plm_imp_pan_sdg13.xfLP2<-plm(sdg13_co2kgPerGDPPPP ~ sdg3_lifee + sdg7_ren + sdg15_cpta + sdg9_patents,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.03). Only 6 vars
fit_plm_imp_pan_sdg14.xfL<-plm(sdg14_cpma ~ sdg3_hiv + sdg3_lifee + sdg14_cleanwat + sdg15_cpta + sdg16_safe + sdg17_govex,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars
fit_plm_imp_pan_sdg14.xfLP<-plm(sdg14_cpma ~ sdg2_undernsh + sdg3_tb
                                + sdg3_lifee + sdg5_lfpr + sdg6_safewat
                                + sdg13_co2kgPerGDPPPP + sdg14_cleanwat + sdg15_cpta,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Extra Pruned Lasso inputs with transformed pan imputed vars
fit_plm_imp_pan_sdg14.xfLP2<-plm(sdg14_cpma ~ sdg3_lifee + sdg6_safewat + sdg15_cpta,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.035). oecdpov, trophic in. Elder, rsf out. Scarcewat cut
fit_plm_imp_pan_sdg15.xfL<-plm(sdg15_redlist ~ sdg1_oecdpov + sdg2_trophic + sdg3_lifee + sdg3_incomeg + sdg10_palma 
                               + sdg15_cpfa + sdg17_oda,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars (lambda = 0.014). pruned down to 6 vars
fit_plm_imp_pan_sdg15.xfLP<-plm(sdg15_redlist ~ sdg3_neonat + sdg3_lifee + sdg3_births + sdg3_incomeg
                                + sdg15_cpfa + sdg16_homicides,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
fit_plm_imp_pan_sdg15.xfLP2<-plm(sdg15_redlist ~ sdg3_neonat + sdg3_lifee + sdg16_homicides,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf)
...
# sdg 16 with lasso variables. s=0.015. oecdpov, cleanfuel in. 320pov, safewat, prison out
fit_plm_imp_pan_sdg16.xfL<-plm(sdg16_homicides ~ sdg1_oecdpov + sdg2_obesity + sdg2_crlyld + sdg3_matmort
                               + sdg3_tb + sdg3_lifee + sdg3_incomeg + sdg7_cleanfuel,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
# Pruned SDG 16 with lasso variables.
fit_plm_imp_pan_sdg16.xfLP<-plm(sdg16_homicides ~ sdg2_undernsh + sdg2_obesity + sdg2_trophic
                                + sdg3_u5mort + sdg3_tb + sdg3_lifee + sdg7_cleanfuel
                                + sdg11_pm25,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
# Extra Pruned SDG 16 with lasso variables. 
fit_plm_imp_pan_sdg16.xfLP2<-plm(sdg16_homicides ~ sdg2_obesity + sdg3_tb + sdg3_lifee + sdg7_cleanfuel,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf)
...
#Lasso inputs with transformed pan imputed vars (lambda = 0.055). crlyld, safe out. adjgini in
fit_plm_imp_pan_sdg17.xfL<-plm(sdg17_govex ~ sdg1_oecdpov + sdg2_trophic + sdg5_lfpr + sdg5_parl
                               + sdg9_articles + sdg9_rdres + sdg10_adjgini + sdg11_pm25 + sdg16_cpi,
                               model='random',
                               effect='twoway',
                               data=data.pan.final.xf)
...
#Pruned Lasso inputs with transformed pan imputed vars. (lambda = 0.02). Using vars 
#from other set of countres was better than from lasso on this set of countries
fit_plm_imp_pan_sdg17.xfLP<-plm(sdg17_govex ~ GDP_PPP + sdg1_oecdpov + sdg2_crlyld
                                + sdg5_lfpr + sdg5_parl + sdg7_ren + sdg9_articles
                                + sdg14_fishstocks + sdg16_cpi + sdg17_oda,
                                model='random',
                                effect='twoway',
                                data=data.pan.final.xf)
...
#Extra Pruned Lasso inputs with transformed pan imputed vars.
fit_plm_imp_pan_sdg17.xfLP2<-plm(sdg17_govex ~ GDP_PPP + sdg5_lfpr + sdg9_articles + sdg17_oda,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf)
...
for (j in 1:num_countries){
  ...
  #SDG1#
  fit_plm_imp_pan_sdg1.xf.t<-plm(sdg1_oecdpov ~ sdg1_wpc + sdg1_320pov + sdg4_tertiary + GDP_PPP,
                                 model='random',
                                 effect='twoway',
  ...
  fit_plm_imp_pan_sdg1.xf.tL<-plm(sdg1_oecdpov ~ sdg1_wpc + sdg2_crlyld + sdg2_snmi + sdg4_tertiary 
                                  + sdg10_adjgini + sdg10_palma + sdg10_elder + sdg15_cpfa  + sdg16_rsf,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg1.xf.tLP<-plm(sdg1_oecdpov ~ sdg2_crlyld + sdg2_snmi + sdg4_tertiary
                                   + sdg8_empop + sdg10_palma
                                   + sdg10_elder + sdg16_rsf + sdg17_oda,
                                   model='random',
                                   effect='twoway',
  ...
  #SDG2#
  fit_plm_imp_pan_sdg2.xf.t<-plm(sdg2_undernsh ~ sdg1_oecdpov + sdg3_u5mort + sdg3_lifee + sdg2_crlyld + sdg14_fishstocks
                                 + sdg11_pipedwat + sdg15_redlist,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf[train_countries,])
  ...
  #Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg2.xf.tL<-plm(sdg2_undernsh ~ sdg2_wasteihme + sdg3_lifee + sdg3_fertility + sdg4_tertiary + sdg7_elecac 
                                  + sdg7_cleanfuel + sdg13_co2kgPerGDPPPP + sdg16_rsf,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg2.xf.tLP<-plm(sdg2_undernsh ~ sdg2_wasteihme + sdg2_obesity
                                   + sdg3_fertility + sdg6_safewat + sdg7_cleanfuel + sdg8_yneet
                                   + sdg11_pipedwat + sdg13_co2kgPerGDPPPP + sdg16_homicides,
                                   model='random',
                                   effect='twoway',
  ...
  #SDG3#
  fit_plm_imp_pan_sdg3.xf.t<-plm(sdg3_lifee ~ sdg1_oecdpov + sdg2_undernsh + sdg4_primary + sdg4_tertiary + sdg5_edat + sdg6_safesan,
                                 model='random',
                                 effect='twoway',
                                 data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg3.xf.tL<-plm(sdg3_lifee ~ GDP_PPP + sdg2_stuntihme + sdg2_wasteihme + sdg3_smoke 
                                  + sdg4_tertiary + sdg6_safewat + sdg9_articles + sdg15_redlist + sdg16_homicides,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  # Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg3.xf.tLP<-plm(sdg3_lifee ~ GDP_PPP + sdg3_matmort + sdg3_smoke + sdg4_tertiary
                                   + sdg9_articles + sdg13_co2kgPerGDPPPP + sdg16_homicides + sdg16_safe,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  # Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg3.xf.tLP2<-plm(sdg3_lifee ~ GDP_PPP + sdg3_smoke + sdg4_tertiary
                                    + sdg9_articles + sdg13_co2kgPerGDPPPP,
                                    model='random',
                                    effect='twoway',
                                    data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg4.xf.tL<-plm(sdg4_tertiary ~ sdg1_oecdpov + sdg2_undernsh + sdg3_lifee + sdg3_fertility 
                                  + sdg5_paygap + sdg8_yneet + sdg9_intuse + sdg9_rdex,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg4.xf.tLP<-plm(sdg4_tertiary ~ sdg1_320pov + sdg2_undernsh + sdg3_lifee + sdg3_swb 
                                   + sdg7_ren + sdg8_yneet + sdg9_intuse + sdg9_rdex,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  #Extra Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg4.xf.tLP2<-plm(sdg4_tertiary ~ sdg1_320pov + sdg3_lifee
                                    + sdg8_yneet + sdg9_intuse + sdg9_rdex,
                                    model='random',
                                    effect='twoway',
                                    data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg5.xf.tL<-plm(sdg5_parl ~ sdg2_wasteihme + sdg5_lfpr + sdg7_ren + sdg9_intuse
                                  + sdg16_safe + sdg16_cpi + sdg16_rsf + sdg17_govex + sdg17_oda,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg5.xf.tLP<-plm(sdg5_parl ~ sdg2_wasteihme + sdg2_snmi + sdg5_lfpr + sdg5_paygap + sdg6_safesan
                                   + sdg9_intuse + sdg9_rdres + sdg16_rsf,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg5.xf.tLP2<-plm(sdg5_parl ~ sdg5_lfpr + sdg6_safesan + sdg9_intuse + sdg9_rdres,
                                    model='random',
                                    effect='twoway',
                                    data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg6.xf.tL<-plm(sdg6_safesan ~ sdg3_neonat + sdg3_fertility + sdg4_earlyedu + sdg9_intuse + sdg9_patents
                                  + sdg10_palma + sdg14_cpma + sdg15_cpfa,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg6.xf.tLP<-plm(sdg6_safesan ~ sdg3_fertility + sdg5_parl
                                   + sdg5_paygap + sdg7_elecac + sdg9_intuse + sdg9_patents
                                   + sdg10_palma + sdg14_cpma + sdg15_cpta,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  #Extra Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg6.xf.tLP2<-plm(sdg6_safesan ~ sdg3_fertility + sdg5_parl + sdg7_elecac + sdg9_intuse + sdg9_patents,
                                    model='random',
                                    effect='twoway',
                                    data=data.pan.final.xf[train_countries,])
  ...
  #Lasso inputs with transformed pan imputed vars (lambda = 0.03)
  fit_plm_imp_pan_sdg7.xf.tL<-plm(sdg7_ren ~ Population + sdg2_trophic + sdg3_hiv + sdg5_parl + sdg5_paygap
                                  + sdg8_impacc + sdg11_rentover + sdg13_co2kgPerGDPPPP,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg7.xf.tLP<-plm(sdg7_ren ~ Population + sdg2_trophic + sdg2_snmi + sdg3_matmort + sdg5_lfpr
                                   + sdg8_impacc + sdg8_empop + sdg11_pm25 + sdg13_co2kgPerGDPPPP,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  #Extra Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg7.xf.tLP2<-plm(sdg7_ren ~ sdg2_trophic + sdg2_stuntihme + sdg5_lfpr + sdg11_pm25 + sdg13_co2kgPerGDPPPP,
                                    model='random',
                                    effect='twoway',
                                    data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg8.xf.tL<-plm(sdg8_empop ~ sdg5_lfpr + sdg7_ren + sdg8_yneet + sdg9_intuse
                                  + sdg9_patents + sdg11_pm25 + sdg16_cpi,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars.
  fit_plm_imp_pan_sdg8.xf.tLP<-plm(sdg8_empop ~ GDP_PPP + sdg3_swb + sdg3_incomeg + sdg4_second + sdg4_earlyedu
                                   + sdg8_yneet + sdg9_intuse + sdg11_pm25,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  #Extra Pruned Lasso inputs with transformed pan imputed vars.
  fit_plm_imp_pan_sdg8.xf.tLP2<-plm(sdg8_empop ~ sdg3_incomeg + sdg8_yneet + sdg9_intuse + sdg11_pm25,
                                    model='random',
                                    effect='twoway',
                                    data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg9.xf.tL<-plm(sdg9_rdex ~ sdg3_lifee + sdg3_fertility + sdg5_paygap + sdg9_articles + sdg9_rdres + sdg9_patents
                                  + sdg14_cleanwat + sdg15_cpta,
                                  model='random',
                                  effect='twoway',
                                  data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg9.xf.tLP<-plm(sdg9_rdex ~ sdg2_undernsh + sdg3_lifee + sdg3_smoke
                                   + sdg5_paygap + sdg8_impacc + sdg9_articles + sdg9_rdres + sdg9_patents,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars.
  fit_plm_imp_pan_sdg10.xf.tLP<-plm(sdg10_palma ~ sdg1_320pov + sdg1_oecdpov + sdg4_tertiary
                                    + sdg5_fplmodel + sdg6_safesan + sdg10_adjgini
                                    + sdg11_pm25 + sdg14_cleanwat,
                                    model='random',
                                    effect='twoway',
  ...
  #Extra Pruned Lasso inputs with transformed pan imputed vars.
  fit_plm_imp_pan_sdg10.xf.tLP2<-plm(sdg10_palma ~ sdg1_oecdpov + sdg4_tertiary + sdg6_safesan,
                                     model='random',
                                     effect='twoway',
                                     data=data.pan.final.xf[train_countries,])
  ...
  #Lasso inputs with transformed pan imputed vars (lambda = 0.035)
  fit_plm_imp_pan_sdg11.xf.tL<-plm(sdg11_pm25 ~ sdg2_trophic + sdg3_neonat + sdg5_edat + sdg5_lfpr + sdg8_impacc + sdg8_empop + sdg9_rdex
                                   + sdg16_cpi + sdg16_rsf,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg11.xf.tLP<-plm(sdg11_pm25 ~ sdg1_wpc + sdg2_trophic + sdg3_neonat + sdg3_vac
                                    + sdg5_edat + sdg5_lfpr + sdg6_scarcew + sdg7_elecac + sdg8_impacc + sdg8_empop + sdg9_rdres
                                    + sdg16_cpi + sdg16_rsf,
                                    model='random',
                                    effect='twoway',
  ...
  fit_plm_imp_pan_sdg11.xf.tLP2<-plm(sdg11_pm25 ~ sdg3_neonat + sdg3_vac + sdg5_lfpr + sdg8_empop + sdg9_rdres,
                                     model='random',
                                     effect='twoway',
                                     data=data.pan.final.xf[train_countries,])
  ...
  #Lasso inputs with transformed pan imputed vars (lambda = 0.035)
  fit_plm_imp_pan_sdg13.xf.tL<-plm(sdg13_co2kgPerGDPPPP ~ sdg2_crlyld + sdg3_lifee + sdg4_earlyedu + sdg5_paygap + sdg7_cleanfuel
                                   + sdg7_ren + sdg9_intuse + sdg16_rsf,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg13.xf.tLP<-plm(sdg13_co2kgPerGDPPPP ~ sdg2_wasteihme + sdg3_lifee
                                    + sdg7_cleanfuel + sdg7_ren + sdg9_intuse + sdg9_patents + sdg14_cleanwat + sdg15_cpfa,
                                    model='random',
                                    effect='twoway',
                                    data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg13.xf.tLP2<-plm(sdg13_co2kgPerGDPPPP ~ sdg3_lifee + sdg7_ren + sdg15_cpta + sdg9_patents,
                                     model='random',
                                     effect='twoway',
                                     data=data.pan.final.xf[train_countries,])
  ...
  #Lasso inputs with transformed pan imputed vars (lambda = 0.035)
  fit_plm_imp_pan_sdg14.xf.tL<-plm(sdg14_cpma ~ sdg3_hiv + sdg3_lifee + sdg14_cleanwat + sdg15_cpta + sdg16_safe + sdg17_govex,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg14.xf.tLP<-plm(sdg14_cpma ~ sdg2_undernsh + sdg3_tb
                                    + sdg3_lifee + sdg5_lfpr + sdg6_safewat
                                    + sdg13_co2kgPerGDPPPP + sdg14_cleanwat + sdg15_cpta,
                                    model='random',
                                    effect='twoway',
  ...
  #Extra Pruned Lasso inputs with transformed pan imputed vars
  fit_plm_imp_pan_sdg14.xf.tLP2<-plm(sdg14_cpma ~ sdg3_lifee + sdg6_safewat + sdg15_cpta,
                                     model='random',
                                     effect='twoway',
                                     data=data.pan.final.xf[train_countries,])
  ...
  #Lasso inputs with transformed pan imputed vars (lambda = 0.035)
  fit_plm_imp_pan_sdg15.xf.tL<-plm(sdg15_redlist ~ sdg1_oecdpov + sdg2_trophic + sdg3_lifee + sdg3_incomeg + sdg10_palma 
                                   + sdg15_cpfa + sdg17_oda,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg15.xf.tLP<-plm(sdg15_redlist ~ sdg3_neonat + sdg3_lifee + sdg3_births + sdg3_incomeg
                                    + sdg15_cpfa + sdg16_homicides,
                                    model='random',
                                    effect='twoway',
                                    data=data.pan.final.xf[train_countries,])
  ...
  #Pruned Lasso inputs with transformed pan imputed vars (lambda = 0.035)
  fit_plm_imp_pan_sdg15.xf.tLP2<-plm(sdg15_redlist ~ sdg3_neonat + sdg3_lifee + sdg16_homicides,
                                     model='random',
                                     effect='twoway',
                                     data=data.pan.final.xf[train_countries,])
  ...
  fit_plm_imp_pan_sdg16.xf.tL<-plm(sdg16_homicides ~ sdg1_oecdpov + sdg2_obesity + sdg2_crlyld + sdg3_matmort
                                   + sdg3_tb + sdg3_lifee + sdg3_incomeg + sdg7_cleanfuel,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  # Pruned SDG 16 with lasso variables.
  fit_plm_imp_pan_sdg16.xf.tLP<-plm(sdg16_homicides ~ sdg2_undernsh + sdg2_obesity + sdg2_trophic
                                    + sdg3_u5mort + sdg3_tb + sdg3_lifee + sdg7_cleanfuel
                                    + sdg11_pm25,
                                    model='random',
                                    effect='twoway',
  ...
  fit_plm_imp_pan_sdg16.xf.tLP2<-plm(sdg16_homicides ~ sdg2_obesity + sdg3_tb + sdg3_lifee + sdg7_cleanfuel,
                                     model='random',
                                     effect='twoway',
                                     data=data.pan.final.xf[train_countries,])
  ...
  #Lasso inputs with transformed pan imputed vars (lambda = 0.03)
  fit_plm_imp_pan_sdg17.xf.tL<-plm(sdg17_govex ~ sdg1_oecdpov + sdg2_trophic + sdg5_lfpr + sdg5_parl
                                   + sdg9_articles + sdg9_rdres + sdg10_adjgini + sdg11_pm25 + sdg16_cpi,
                                   model='random',
                                   effect='twoway',
                                   data=data.pan.final.xf[train_countries,])
  ...
  #Extra Pruned Lasso inputs with transformed pan imputed vars.
  fit_plm_imp_pan_sdg17.xf.tLP2<-plm(sdg17_govex ~ GDP_PPP + sdg5_lfpr + sdg9_articles + sdg17_oda,
                                     model='random',
                                     effect='twoway',
                                     data=data.pan.final.xf[train_countries,])
...
ISR_val_MMSR<-mean(MSRs[18,])
ITA_val_MMSR<-mean(MSRs[19,])
JPN_val_MMSR<-mean(MSRs[20,])
KOR_val_MMSR<-mean(MSRs[21,])
LTU_val_MMSR<-mean(MSRs[22,])
LUX_val_MMSR<-mean(MSRs[23,])
LVA_val_MMSR<-mean(MSRs[24,])
#MEX_val_MMSR<-mean(MSRs[26,])
NLD_val_MMSR<-mean(MSRs[25,])
NOR_val_MMSR<-mean(MSRs[26,])
NZL_val_MMSR<-mean(MSRs[27,])
POL_val_MMSR<-mean(MSRs[28,])
PRT_val_MMSR<-mean(MSRs[29,])
SVK_val_MMSR<-mean(MSRs[30,])
SVN_val_MMSR<-mean(MSRs[31,])
SWE_val_MMSR<-mean(MSRs[32,])
TUR_val_MMSR<-mean(MSRs[33,])
...
#percent difference between validation error and traiining error for each sdg
sdg1_error_diff_Lasso<-100*(sdg1_val_MMSR-sdg1_train_MMSR_Lasso)/sdg1_train_MMSR_Lasso
sdg2_error_diff_Lasso<-100*(sdg2_val_MMSR-sdg2_train_MMSR_Lasso)/sdg2_train_MMSR_Lasso
sdg3_error_diff_Lasso<-100*(sdg3_val_MMSR-sdg3_train_MMSR_Lasso)/sdg3_train_MMSR_Lasso
sdg4_error_diff_Lasso<-100*(sdg4_val_MMSR-sdg4_train_MMSR_Lasso)/sdg4_train_MMSR_Lasso
sdg5_error_diff_Lasso<-100*(sdg5_val_MMSR-sdg5_train_MMSR_Lasso)/sdg5_train_MMSR_Lasso
sdg6_error_diff_Lasso<-100*(sdg6_val_MMSR-sdg6_train_MMSR_Lasso)/sdg6_train_MMSR_Lasso
sdg7_error_diff_Lasso<-100*(sdg7_val_MMSR-sdg7_train_MMSR_Lasso)/sdg7_train_MMSR_Lasso
sdg8_error_diff_Lasso<-100*(sdg8_val_MMSR-sdg8_train_MMSR_Lasso)/sdg8_train_MMSR_Lasso
sdg9_error_diff_Lasso<-100*(sdg9_val_MMSR-sdg9_train_MMSR_Lasso)/sdg9_train_MMSR_Lasso
sdg10_error_diff_Lasso<-100*(sdg10_val_MMSR-sdg10_train_MMSR_Lasso)/sdg10_train_MMSR_Lasso
sdg11_error_diff_Lasso<-100*(sdg11_val_MMSR-sdg11_train_MMSR_Lasso)/sdg11_train_MMSR_Lasso
sdg13_error_diff_Lasso<-100*(sdg13_val_MMSR-sdg13_train_MMSR_Lasso)/sdg13_train_MMSR_Lasso
sdg14_error_diff_Lasso<-100*(sdg14_val_MMSR-sdg14_train_MMSR_Lasso)/sdg14_train_MMSR_Lasso
sdg15_error_diff_Lasso<-100*(sdg15_val_MMSR-sdg15_train_MMSR_Lasso)/sdg15_train_MMSR_Lasso
sdg16_error_diff_Lasso<-100*(sdg16_val_MMSR-sdg16_train_MMSR_Lasso)/sdg16_train_MMSR_Lasso
sdg17_error_diff_Lasso<-100*(sdg17_val_MMSR-sdg17_train_MMSR_Lasso)/sdg17_train_MMSR_Lasso
...
ISR_val_MMSR_Lasso<-mean(MSRs_Lasso[18,])
ITA_val_MMSR_Lasso<-mean(MSRs_Lasso[19,])
JPN_val_MMSR_Lasso<-mean(MSRs_Lasso[20,])
KOR_val_MMSR_Lasso<-mean(MSRs_Lasso[21,])
LTU_val_MMSR_Lasso<-mean(MSRs_Lasso[22,])
LUX_val_MMSR_Lasso<-mean(MSRs_Lasso[23,])
LVA_val_MMSR_Lasso<-mean(MSRs_Lasso[24,])
#MEX_val_MMSR_Lasso<-mean(MSRs_Lasso[26,])
NLD_val_MMSR_Lasso<-mean(MSRs_Lasso[25,])
NOR_val_MMSR_Lasso<-mean(MSRs_Lasso[26,])
NZL_val_MMSR_Lasso<-mean(MSRs_Lasso[27,])
POL_val_MMSR_Lasso<-mean(MSRs_Lasso[28,])
PRT_val_MMSR_Lasso<-mean(MSRs_Lasso[29,])
SVK_val_MMSR_Lasso<-mean(MSRs_Lasso[30,])
SVN_val_MMSR_Lasso<-mean(MSRs_Lasso[31,])
SWE_val_MMSR_Lasso<-mean(MSRs_Lasso[32,])
TUR_val_MMSR_Lasso<-mean(MSRs_Lasso[33,])
...
Countries_MSR_Lasso.i<-c(AUS_val_MMSR_Lasso,AUT_val_MMSR_Lasso,BEL_val_MMSR_Lasso,CAN_val_MMSR_Lasso,CHE_val_MMSR_Lasso
                         ...
                         ,HUN_val_MMSR_Lasso,IRL_val_MMSR_Lasso,ISR_val_MMSR_Lasso,ITA_val_MMSR_Lasso
                         ,JPN_val_MMSR_Lasso,KOR_val_MMSR_Lasso,LTU_val_MMSR_Lasso,LUX_val_MMSR_Lasso,LVA_val_MMSR_Lasso
                         ,NLD_val_MMSR_Lasso,NOR_val_MMSR_Lasso,NZL_val_MMSR_Lasso,POL_val_MMSR_Lasso
...
sdg1_error_diff_Lasso.P<-100*(sdg1_val_MMSR-sdg1_train_MMSR_Lasso.P)/sdg1_train_MMSR_Lasso.P
sdg2_error_diff_Lasso.P<-100*(sdg2_val_MMSR-sdg2_train_MMSR_Lasso.P)/sdg2_train_MMSR_Lasso.P
sdg3_error_diff_Lasso.P<-100*(sdg3_val_MMSR-sdg3_train_MMSR_Lasso.P)/sdg3_train_MMSR_Lasso.P
sdg4_error_diff_Lasso.P<-100*(sdg4_val_MMSR-sdg4_train_MMSR_Lasso.P)/sdg4_train_MMSR_Lasso.P
sdg5_error_diff_Lasso.P<-100*(sdg5_val_MMSR-sdg5_train_MMSR_Lasso.P)/sdg5_train_MMSR_Lasso.P
sdg6_error_diff_Lasso.P<-100*(sdg6_val_MMSR-sdg6_train_MMSR_Lasso.P)/sdg6_train_MMSR_Lasso.P
sdg7_error_diff_Lasso.P<-100*(sdg7_val_MMSR-sdg7_train_MMSR_Lasso.P)/sdg7_train_MMSR_Lasso.P
sdg8_error_diff_Lasso.P<-100*(sdg8_val_MMSR-sdg8_train_MMSR_Lasso.P)/sdg8_train_MMSR_Lasso.P
sdg9_error_diff_Lasso.P<-100*(sdg9_val_MMSR-sdg9_train_MMSR_Lasso.P)/sdg9_train_MMSR_Lasso.P
sdg10_error_diff_Lasso.P<-100*(sdg10_val_MMSR-sdg10_train_MMSR_Lasso.P)/sdg10_train_MMSR_Lasso.P
sdg11_error_diff_Lasso.P<-100*(sdg11_val_MMSR-sdg11_train_MMSR_Lasso.P)/sdg11_train_MMSR_Lasso.P
sdg13_error_diff_Lasso.P<-100*(sdg13_val_MMSR-sdg13_train_MMSR_Lasso.P)/sdg13_train_MMSR_Lasso.P
sdg14_error_diff_Lasso.P<-100*(sdg14_val_MMSR-sdg14_train_MMSR_Lasso.P)/sdg14_train_MMSR_Lasso.P
sdg15_error_diff_Lasso.P<-100*(sdg15_val_MMSR-sdg15_train_MMSR_Lasso.P)/sdg15_train_MMSR_Lasso.P
sdg16_error_diff_Lasso.P<-100*(sdg16_val_MMSR-sdg16_train_MMSR_Lasso.P)/sdg16_train_MMSR_Lasso.P
sdg17_error_diff_Lasso.P<-100*(sdg17_val_MMSR-sdg17_train_MMSR_Lasso.P)/sdg17_train_MMSR_Lasso.P
...
ISR_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[18,])
ITA_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[19,])
JPN_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[20,])
KOR_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[21,])
LTU_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[22,])
LUX_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[23,])
LVA_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[24,])
#MEX_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[26,])
NLD_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[25,])
NOR_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[26,])
NZL_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[27,])
POL_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[28,])
PRT_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[29,])
SVK_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[30,])
SVN_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[31,])
SWE_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[32,])
TUR_val_MMSR_Lasso.P<-mean(MSRs_Lasso.P[33,])
...
Countries_MSR_Lasso.P.i<-c(AUS_val_MMSR_Lasso.P,AUT_val_MMSR_Lasso.P,BEL_val_MMSR_Lasso.P,CAN_val_MMSR_Lasso.P,CHE_val_MMSR_Lasso.P
                           ...
                           ,HUN_val_MMSR_Lasso.P,IRL_val_MMSR_Lasso.P,ISR_val_MMSR_Lasso.P,ITA_val_MMSR_Lasso.P
                           ,JPN_val_MMSR_Lasso.P,KOR_val_MMSR_Lasso.P,LTU_val_MMSR_Lasso.P,LUX_val_MMSR_Lasso.P,LVA_val_MMSR_Lasso.P
                           ,NLD_val_MMSR_Lasso.P,NOR_val_MMSR_Lasso.P,NZL_val_MMSR_Lasso.P,POL_val_MMSR_Lasso.P
...
#percent difference between validation error and training error for each sdg
sdg1_error_diff_Lasso.P2<-100*(sdg1_val_MMSR-sdg1_train_MMSR_Lasso.P2)/sdg1_train_MMSR_Lasso.P2
sdg2_error_diff_Lasso.P2<-100*(sdg2_val_MMSR-sdg2_train_MMSR_Lasso.P2)/sdg2_train_MMSR_Lasso.P2
sdg3_error_diff_Lasso.P2<-100*(sdg3_val_MMSR-sdg3_train_MMSR_Lasso.P2)/sdg3_train_MMSR_Lasso.P2
sdg4_error_diff_Lasso.P2<-100*(sdg4_val_MMSR-sdg4_train_MMSR_Lasso.P2)/sdg4_train_MMSR_Lasso.P2
sdg5_error_diff_Lasso.P2<-100*(sdg5_val_MMSR-sdg5_train_MMSR_Lasso.P2)/sdg5_train_MMSR_Lasso.P2
sdg6_error_diff_Lasso.P2<-100*(sdg6_val_MMSR-sdg6_train_MMSR_Lasso.P2)/sdg6_train_MMSR_Lasso.P2
sdg7_error_diff_Lasso.P2<-100*(sdg7_val_MMSR-sdg7_train_MMSR_Lasso.P2)/sdg7_train_MMSR_Lasso.P2
sdg8_error_diff_Lasso.P2<-100*(sdg8_val_MMSR-sdg8_train_MMSR_Lasso.P2)/sdg8_train_MMSR_Lasso.P2
sdg9_error_diff_Lasso.P2<-100*(sdg9_val_MMSR-sdg9_train_MMSR_Lasso.P2)/sdg9_train_MMSR_Lasso.P2
sdg10_error_diff_Lasso.P2<-100*(sdg10_val_MMSR-sdg10_train_MMSR_Lasso.P2)/sdg10_train_MMSR_Lasso.P2
sdg11_error_diff_Lasso.P2<-100*(sdg11_val_MMSR-sdg11_train_MMSR_Lasso.P2)/sdg11_train_MMSR_Lasso.P2
sdg13_error_diff_Lasso.P2<-100*(sdg13_val_MMSR-sdg13_train_MMSR_Lasso.P2)/sdg13_train_MMSR_Lasso.P2
sdg14_error_diff_Lasso.P2<-100*(sdg14_val_MMSR-sdg14_train_MMSR_Lasso.P2)/sdg14_train_MMSR_Lasso.P2
sdg15_error_diff_Lasso.P2<-100*(sdg15_val_MMSR-sdg15_train_MMSR_Lasso.P2)/sdg15_train_MMSR_Lasso.P2
sdg16_error_diff_Lasso.P2<-100*(sdg16_val_MMSR-sdg16_train_MMSR_Lasso.P2)/sdg16_train_MMSR_Lasso.P2
sdg17_error_diff_Lasso.P2<-100*(sdg17_val_MMSR-sdg17_train_MMSR_Lasso.P2)/sdg17_train_MMSR_Lasso.P2
...
ISR_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[18,])
ITA_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[19,])
JPN_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[20,])
KOR_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[21,])
LTU_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[22,])
LUX_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[23,])
LVA_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[24,])
#MEX_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[26,])
NLD_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[25,])
NOR_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[26,])
NZL_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[27,])
POL_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[28,])
PRT_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[29,])
SVK_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[30,])
SVN_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[31,])
SWE_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[32,])
TUR_val_MMSR_Lasso.P2<-mean(MSRs_Lasso.P2[33,])
...
Countries_MSR_Lasso.P2.i<-c(AUS_val_MMSR_Lasso.P2,AUT_val_MMSR_Lasso.P2,BEL_val_MMSR_Lasso.P2,CAN_val_MMSR_Lasso.P2,CHE_val_MMSR_Lasso.P2
                            ...
                            ,HUN_val_MMSR_Lasso.P2,IRL_val_MMSR_Lasso.P2,ISR_val_MMSR_Lasso.P2,ITA_val_MMSR_Lasso.P2
                            ,JPN_val_MMSR_Lasso.P2,KOR_val_MMSR_Lasso.P2,LTU_val_MMSR_Lasso.P2,LUX_val_MMSR_Lasso.P2,LVA_val_MMSR_Lasso.P2
                            ,NLD_val_MMSR_Lasso.P2,NOR_val_MMSR_Lasso.P2,NZL_val_MMSR_Lasso.P2,POL_val_MMSR_Lasso.P2
...
# look at differences between coefficients 
# try to make larger dataset with all possible interactions #
