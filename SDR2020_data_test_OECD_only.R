...
fit_plm_imp_pan_sdg2.xf<-plm(sdg2_wasteihme ~ sdg3_u5mort + sdg2_stuntihme + sdg6_safesan + sdg2_obesity
                               ...
                               data=data.pan.final)
summary(fit_plm_imp_pan_sdg2.xf)
MSR_fit_plm_imp_pan_sdg2.xf<-mean(fit_plm_imp_pan_sdg2.2.xf$residuals^2)
MSR_fit_plm_imp_pan_sdg2.xf
...
RorF6.xfLP<-phtest(form, data.pan.final)#,model = c("random","within"))
RorF6.xfLP
...
phtest(form9.xfLP,data.pan.final,model = c("within","random"))
...
newdat = data.pan.final[,c(-1,-2)]
newdatnames = matrix(NA,0,1)
for (k in 1:(length(data.pan.final)-3)){
  for (n in (k+1):(length(data.pan.final)-2)){
    newdat[,length(newdat)+1] = newdat[,k]*newdat[,n]
    newdatnames[length(newdatnames)+1]<- paste(names(newdat[k]),"*",names(newdat[n]), sep="")
  }
}
newdat=c(data.pan.final[1:2],newdat)
names(newdat)[(length(data.pan.final)+1):length(newdat)]<-newdatnames
...
plot(fit_plm_imp_pan_sdg1.xf$residuals)
plot(fit_plm_imp_pan_sdg1.xfL$residuals)
plot(fit_plm_imp_pan_sdg1.xfLP$residuals)
plot(fit_plm_imp_pan_sdg1.intLP2$residuals)
plot(fit_plm_imp_pan_sdg1.int$residuals)
plot(fit_plm_imp_pan_sdg1.int2$residuals)
...
fit_plm_imp_pan_sdg1.xf.t<-plm(sdg1_oecdpov ~ sdg4_tertiary + sdg3_lifee + sdg2_undernsh + 
                           ...
                           model='random',
                           effect='twoway',
                           data=data.pan.final[train_countries,])
...
val_pred<-predict(fit_plm_imp_pan_sdg1.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg1.xf.v[j]<-mean((val_pred-data.pan.final$sdg1_oecdpov[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg1.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg1.xf.vL[j]<-mean((val_pred-data.pan.final$sdg1_oecdpov[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg1.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg1.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg1_oecdpov[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg1.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg1.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg1_oecdpov[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg1.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg1.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg1_oecdpov[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg1.xf.tLint2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg1.xf.vLint2[j]<-mean((val_pred-data.pan.final$sdg1_oecdpov[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg2.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg2.xf.v[j]<-mean((val_pred-data.pan.final$sdg2_wasteihme[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg2.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg2.xf.vL[j]<-mean((val_pred-data.pan.final$sdg2_wasteihme[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg2.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg2.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg2_wasteihme[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg2.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg2.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg2_wasteihme[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg2.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg2.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg2_wasteihme[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg2.xf.tLint2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg2.xf.vLint2[j]<-mean((val_pred-data.pan.final$sdg2_wasteihme[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg3.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg3.xf.v[j]<-mean((val_pred-data.pan.final$sdg3_lifee[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg3.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg3.xf.vL[j]<-mean((val_pred-data.pan.final$sdg3_lifee[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg3.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg3.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg3_lifee[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg3.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg3.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg3_lifee[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg3.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg3.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg3_lifee[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg3.xf.tLint2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg3.xf.vLint2[j]<-mean((val_pred-data.pan.final$sdg3_lifee[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg4.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg4.xf.v[j]<-mean((val_pred-data.pan.final$sdg4_tertiary[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg4.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg4.xf.vL[j]<-mean((val_pred-data.pan.final$sdg4_tertiary[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg4.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg4.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg4_tertiary[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg4.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg4.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg4_tertiary[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg4.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg4.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg4_tertiary[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg5.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg5.xf.v[j]<-mean((val_pred-data.pan.final$sdg5_parl[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg5.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg5.xf.vL[j]<-mean((val_pred-data.pan.final$sdg5_parl[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg5.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg5.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg5_parl[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg5.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg5.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg5_parl[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg5.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg5.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg5_parl[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg6.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg6.xf.v[j]<-mean((val_pred-data.pan.final$sdg6_safesan[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg6.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg6.xf.vL[j]<-mean((val_pred-data.pan.final$sdg6_safesan[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg6.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg6.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg6_safesan[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg6.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg6.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg6_safesan[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg6.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg6.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg6_safesan[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg7.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg7.xf.v[j]<-mean((val_pred-data.pan.final$sdg7_ren[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg7.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg7.xf.vL[j]<-mean((val_pred-data.pan.final$sdg7_ren[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg7.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg7.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg7_ren[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg7.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg7.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg7_ren[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg7.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg7.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg7_ren[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg8.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg8.xf.v[j]<-mean((val_pred-data.pan.final$sdg8_empop[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg8.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg8.xf.vL[j]<-mean((val_pred-data.pan.final$sdg8_empop[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg8.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg8.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg8_empop[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg8.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg8.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg8_empop[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg8.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg8.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg8_empop[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg8.xf.tLint2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg8.xf.vLint2[j]<-mean((val_pred-data.pan.final$sdg8_empop[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg9.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg9.xf.v[j]<-mean((val_pred-data.pan.final$sdg9_rdex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg9.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg9.xf.vL[j]<-mean((val_pred-data.pan.final$sdg9_rdex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg9.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg9.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg9_rdex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg9.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg9.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg9_rdex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg9.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg9.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg9_rdex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg9.xf.tLint2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg9.xf.vLint2[j]<-mean((val_pred-data.pan.final$sdg9_rdex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg10.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg10.xf.v[j]<-mean((val_pred-data.pan.final$sdg10_palma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg10.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg10.xf.vL[j]<-mean((val_pred-data.pan.final$sdg10_palma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg10.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg10.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg10_palma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg10.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg10.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg10_palma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg10.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg10.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg10_palma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg10.xf.tLint2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg10.xf.vLint2[j]<-mean((val_pred-data.pan.final$sdg10_palma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg11.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg11.xf.v[j]<-mean((val_pred-data.pan.final$sdg11_pm25[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg11.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg11.xf.vL[j]<-mean((val_pred-data.pan.final$sdg11_pm25[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg11.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg11.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg11_pm25[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg11.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg11.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg11_pm25[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg11.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg11.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg11_pm25[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg13.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg13.xf.v[j]<-mean((val_pred-data.pan.final$sdg13_co2kgPerGDPPPP[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg13.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg13.xf.vL[j]<-mean((val_pred-data.pan.final$sdg13_co2kgPerGDPPPP[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg13.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg13.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg13_co2kgPerGDPPPP[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg13.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg13.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg13_co2kgPerGDPPPP[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg13.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg13.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg13_co2kgPerGDPPPP[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg14.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg14.xf.v[j]<-mean((val_pred-data.pan.final$sdg14_cpma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg14.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg14.xf.vL[j]<-mean((val_pred-data.pan.final$sdg14_cpma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg14.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg14.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg14_cpma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg14.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg14.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg14_cpma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg14.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg14.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg14_cpma[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg15.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg15.xf.v[j]<-mean((val_pred-data.pan.final$sdg15_redlist[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg15.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg15.xf.vL[j]<-mean((val_pred-data.pan.final$sdg15_redlist[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg15.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg15.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg15_redlist[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg15.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg15.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg15_redlist[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg15.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg15.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg15_redlist[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg16.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg16.xf.v[j]<-mean((val_pred-data.pan.final$sdg16_homicides[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg16.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg16.xf.vL[j]<-mean((val_pred-data.pan.final$sdg16_homicides[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg16.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg16.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg16_homicides[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg16.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg16.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg16_homicides[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg16.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg16.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg16_homicides[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg17.xf.t,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg17.xf.v[j]<-mean((val_pred-data.pan.final$sdg17_govex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg17.xf.tL,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg17.xf.vL[j]<-mean((val_pred-data.pan.final$sdg17_govex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg17.xf.tLP,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg17.xf.vLP[j]<-mean((val_pred-data.pan.final$sdg17_govex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg17.xf.tLP2,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg17.xf.vLP2[j]<-mean((val_pred-data.pan.final$sdg17_govex[val_country])^2)
...
val_pred<-predict(fit_plm_imp_pan_sdg17.xf.tLint,data.pan.final[val_country,])
MSR_fit_plm_imp_pan_sdg17.xf.vLint[j]<-mean((val_pred-data.pan.final$sdg17_govex[val_country])^2)
}
...
for (h in 13){#c(seq(1:11),seq(13,17))){
  sdgnum = as.name(h)
...
for (p in 13){#c(seq(1:11),seq(13,17))){
  sdgnum3 = as.name(p)
...
pgrangertest(sdg13_co2kgPerGDPPPP ~ sdg7_ren, data.pan.final, test = c("Ztilde","Zbar","Wbar"), order = 1L)
pgrangertest(sdg13_co2kgPerGDPPPP ~ GDP_PPP, data.pan.final, test = c("Ztilde","Zbar","Wbar"), order = 1L)
pgrangertest(sdg13_co2kgPerGDPPPP ~ sdg10_palma, data.pan.final, test = c("Ztilde","Zbar","Wbar"), order = 1L)
RorF1.int
RorF2.int
RorF3.int
